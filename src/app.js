...
import audioVideoRoute from './modules/audio_video_rec/audio_video_rec.routes.js';
import folderRoute from './modules/folders/folders.routes.js';
...
app.use('/api/v1/audio-video-rec', audioVideoRoute);
